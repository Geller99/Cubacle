export const cubexAbi = [
  ...
  {
    inputs: [
      { internalType: "address", name: "_withdrawWallet", type: "address" },
    ],
    name: "updateWithdrawWallet",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
